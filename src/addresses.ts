...
const addresses: { [chainId: number]: addressesParameter } = {
  ...
  4: {
    ...
    ERC20Proxy: '0xC77d4fD8AdD54E7506f9503FC98Cb0222A2fc058',
    ERC721Proxy: '0x5321BF743829fCDd7961B8bdd210b45786B9aa92',
    ERC1155Proxy: '0x020183C89E93699f5316b836136a033C5a74c7B4',
    Exchange: '0xF563238B5dC0DeE71957413C6fc087bB81faF755',
